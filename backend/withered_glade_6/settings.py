"""
Django settings for withered_glade_6 project.
...
ROOT_URLCONF = 'withered_glade_6.urls'
...
WSGI_APPLICATION = 'withered_glade_6.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "withered_glade_6 API",
    "DESCRIPTION": "API documentation for withered_glade_6 App",
    "VERSION": "v1",
}
